...
from treasure_island import flags
from treasure_island.angle_tools import bear, gcd
from treasure_island.exceptions import AegeanNaNModelError
...
def Cmatrix(x, y, sx, sy, theta):
    ...
    return np.vstack(
        [
            elliptical_gaussian(x, y, 1, i, j, sx, sy, theta)
...
def do_lmfit(data, params, B=None, errs=None, dojac=True):
    ...
    def residual(params, **kwargs):  # noqa: ARG001 TODO: Handle kwargs properly
        """
